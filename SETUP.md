...
- [서버 실행](#서버-실행)
  ...
  - [Spring](#spring)
    - [1. 환경 요구사항](#1-환경-요구사항)
    - [2. 폴더 구조 (Layered Architecture)](#2-폴더-구조-layered-architecture)
    - [3. 서버 실행](#3-서버-실행)
    - [4. 연결 테스트 API](#4-연결-테스트-api)
...
python manage.py listen_redis & daphne -b 0.0.0.0 -p 8000 project.asgi:application
